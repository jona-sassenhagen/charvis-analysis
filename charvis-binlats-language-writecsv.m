...
p6csv = [anovaf firstbinf secondbinf thirdbinf a b];
...
csvwrite('Charvis-P6-RTalign-4binf-rts-lats.csv',p6csv);
...
csvwrite('Charvis-P6-4binf-rts-lats.csv',p6csv);
...
csvwrite('Charvis-P6-sem-4binf-rts-lats.csv',p6csv);
...
for x = 1:n
	...
	[outdata,outrtvar] = erpimage(datas{x}, rts{x}, linspace(EEG.xmin*1000, EEG.xmax*1000, EEG.pnts), '', 1, 1 ,'NoShow','on','filt',[0 20],'baseline',[-500 0]);
...
p6csv = [anovaf firstbinf secondbinf thirdbinf a b];
csvwrite('Charvis-N4-sem-4binf-rts-lats.csv',p6csv);
