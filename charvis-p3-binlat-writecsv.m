...
p3csv = [anovaf firstbinf secondbinf thirdbinf a b];
...
csvwrite('Charvis-P3-4binf-rts-lats.csv',p3csv);
...
for x = 1:n
	...
	[outdata,outrtvar] = erpimage(datas{x}, rts{x}, linspace(EEG2.xmin*1000, EEG2.xmax*1000, EEG2.pnts), '', 1, 1 ,'NoShow','on','align',inf);
...
csvwrite('Charvis-P3-rtalign-4binf-rts-lats.csv',p3csv);
